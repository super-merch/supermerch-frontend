...
const TrendCards = () => {
  ...
  useEffect(() => {
    fetchTrendingProducts(currentPage);
  }, [currentPage]);
        ...
        <div className="lg:w-[75%] w-full  lg:mt-0 md:mt-4 mt-16">
          ...
          <div className="flex flex-wrap items-center justify-between px-5 py-3 mt-4 rounded-md bg-activeFilter">
            ...
            <div className="flex items-center gap-1 pt-3 lg:pt-0 md:pt-0 sm:pt-0 ">
              ...
              <p className="">Trending Results found</p>
            </div>
          </div>
                    ...
                    .map((product) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Add trending badge */}
                          {/* <span className="absolute px-2 py-1 text-xs font-bold text-white bg-orange-500 rounded top-16 right-2">
                            TRENDING
                          </span> */}
