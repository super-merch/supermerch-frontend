...
const AustraliaProducts = () => {
  ...
  const { marginApi, backendUrl, fetchAustraliaProducts, fetchAllAustraliaProducts, australia, skeletonLoading } = useContext(AppContext);
        ...
        <div className="lg:w-[75%] w-full lg:mt-0 md:mt-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <p className="">
                {isLoading || isFiltering ? "Loading..." : `Australia Made Results found${isPriceFilterActive ? " (Price filtered)" : ""}`}
          ...
          >
            {showSkeleton || isLoading || isFiltering ? (
              ...
              <div className="flex items-center justify-center h-full">
                <p className="pt-10 text-xl text-center text-red-500">No Australia Made Products Found</p>
              </div>
            )}
          </div>
