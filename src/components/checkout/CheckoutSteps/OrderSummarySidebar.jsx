                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        {Number(item.discountPct || 0) > 0 && (
                          <span className="text-xs font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded px-2 py-0.5">
                            {Math.round(Number(item.discountPct))}% product discount applied
                          </span>
                        )}
                      </div>
                        ...
                        {item.adminCustomization ? (
                          <>
                            ...
                            {item.adminCustomization.customizationFile?.preview && (
                              <div className="flex items-center gap-2 mt-1">
                                <img
                                  src={item.adminCustomization.customizationFile.preview}
                                  alt="Artwork"
                                  className="w-8 h-8 object-contain rounded border border-gray-200"
                                />
                                <span className="text-xs text-green-600">Artwork uploaded</span>
                              </div>
                            )}
                          </>
                        ) : (
