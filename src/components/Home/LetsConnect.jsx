...
const LetsConnect = () => {
  ...
  const fallbackPosts = [
    ...
    },
    {
      id: "fallback-4",
      image: "/pens.jfif",
      caption: "Professional Writing Tools - Branded pens for your business! ✍️",
      link: "https://www.instagram.com/supermerch_official?igsh=N2FnNndiaHNsbnkw",
    },
  ];
        ...
        >
          <div className="flex justify-center mt-4">
            <a
              ...
              className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-full hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl text-sm"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {instagramPosts.map((post, index) => (
              ...
              >
                ...
                {/* Post Caption */}
                <div className="p-4">
                  <p className="text-sm text-gray-700 line-clamp-3 group-hover:text-blue-600 transition-colors duration-300">
                    {post.caption}
                  </p>
