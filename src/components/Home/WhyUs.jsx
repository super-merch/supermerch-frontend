    ...
    <section className={`bg-white text-gray-800 py-12 ${className}`} aria-labelledby="why-us-heading">
      <div className="max-w-6xl mx-auto px-6">
        <header className="mb-8 text-center">
          <h2 id="why-us-heading" className="text-3xl font-semibold text-blue-900">Why Choose Us</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <article className="flex items-start gap-4 p-5 border rounded-lg shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-blue-900 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 7h18M6 7v12a2 2 0 002 2h8a2 2 0 002-2V7" />
            </svg>
            <div>
              <h3 className="text-lg font-medium text-blue-900">Top Australian Brands</h3>
          ...
          <article className="flex items-start gap-4 p-5 border rounded-lg shadow-sm">
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-900">Trusted Payments (Stripe)</h3>
          ...
          <article className="flex items-start gap-4 p-5 border rounded-lg shadow-sm">
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-900">Quality Guaranteed</h3>
          ...
          <article className="flex items-start gap-4 p-5 border rounded-lg shadow-sm">
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-900">Fast & Responsive Service</h3>
          ...
          <article className="flex items-start gap-4 p-5 border rounded-lg shadow-sm">
            ...
            <div>
              <h3 className="text-lg font-medium text-blue-900">Bulk Orders & Competitive Pricing</h3>
