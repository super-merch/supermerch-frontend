...
const GoogleReviews = () => {
  ...
  const fetchGoogleReviews = async () => {
    try {
      ...
      // Note: Google Places API requires proper setup and API key
      // For now, we'll use fallback data
      // In production, you would need to:
      // 1. Set up Google Places API
      // 2. Get API key
      // 3. Make API calls to fetch reviews
    ...
    <div className="w-full py-12 bg-white">
      <div className="Mycontainer">
        ...
        <div className="text-center mt-8">
          <a
            href="https://www.google.com/search?q=super+merch+reviews"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition-colors duration-300 shadow-lg hover:shadow-xl"
          >
