    ...
    <div className="pb-6 Mycontainer lg:pb-10 md:pb-10">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-4">
          <Heading title="Trending Now" align="left" size="default" titleClassName="font-bold text-smallHeader" containerClassName="" />
          <p className="text-sm text-black">Deals ends in</p>
          <p className="px-2 py-2 text-base text-white bg-heading">16d : 21h : 57m : 23s</p>
        </div>
                    ...
                    >
                      ...
                      <div className="p-4">
                        <div className="text-center ">
                          <h2 className="text-lg font-bold text-brand ">{product.overview.name ? product.overview.name : "No Name "}</h2>
                        ...
                        <div className="flex justify-between gap-1 mt-6 mb-2">
                          ...
                          >
                            ...
                            <button onClick={() => handleViewProduct(product.meta.id)} className="text-sm uppercase">
                              Add to cart
                            </button>
                          </div>
                          <p className="p-3 text-2xl rounded-sm bg-icons">
