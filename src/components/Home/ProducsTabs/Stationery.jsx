  ...
  const fetchClothingProducts = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/api/client-products/category?category=Stationery&page=1&limit=8&filter=true`
      );
      ...
      setProducts(data.data.slice(0, 4)); // Ensure only 4 products
    } catch (err) {
                  ...
                  .map((product) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="max-h-[62%] sm:max-h-[71%] h-full border-b overflow-hidden relative rounded-t-xl">
                          <img
                          ...
                          <div className="text-left">
                            <div className="flex items-center justify-between">
                              <h2
                                ...
                                } font-semibold text-brand group-hover:text-blue-600 sm:leading-[18px] flex-1`}
                              >
