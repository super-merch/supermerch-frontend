...
const AllProducts = ({ activeTab }) => {
  ...
  const { fetchProducts, error, marginApi, getGlobalDiscount, totalDiscount } = useContext(AppContext);
  ...
  const fetchAllProducts = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/client-products?page=1&limit=42&sort=&filter=true`);
          ...
          <div className="grid gap-6 max-default:grid-cols-1 lg:grid-cols-4 max-md:grid-cols-3 max-sm:grid-cols-2">
            {skeletonLoading
              ? Array.from({ length: 4 }).map((_, index) => (
                  ...
                  >
                    <Skeleton height={150} className="sm:h-[200px] rounded-t-xl" />
                    <div className="p-4 rounded-b-xl">
                      <Skeleton height={16} width={100} className="sm:h-5 sm:w-[120px] rounded" />
                      <Skeleton height={12} width={60} className="mt-2 sm:h-[15px] sm:w-20 rounded" />
                      <Skeleton height={20} width={80} className="mt-3 sm:h-[25px] sm:w-[100px] rounded" />
                      <Skeleton height={12} width={50} className="mt-2 sm:h-[15px] sm:w-[60px] rounded" />
                      ...
                      <div className="flex justify-between gap-1 mt-4 sm:mt-6 mb-2">
                        ...
                        <Skeleton height={32} width={80} className="sm:h-10 sm:w-[120px] rounded" />
                        <Skeleton circle height={32} width={32} className="sm:h-10 sm:w-10" />
                      </div>
                    </div>
                  </div>
              ...
              : products
                  ...
                  .map((product) => {
                    ...
                    return (
                      <div
                        key={productId}
                        className="relative bg-white border border-border2 rounded-xl shadow-lg hover:shadow-xl hover:border-blue-500 transition-all duration-300 cursor-pointer max-h-[320px] sm:max-h-[400px] h-full group overflow-hidden"
                      ...
                      >
                        ...
                        <div className="absolute top-2 right-2 z-20">
                          <div
                            ...
                            className="p-2 bg-white bg-opacity-80 backdrop-blur-sm rounded-full shadow-md cursor-pointer hover:bg-opacity-100"
                          >
                        ...
                        <div className="max-h-[65%] sm:max-h-[70%] h-full border-b overflow-hidden relative rounded-t-xl">
                          <img
                          ...
                          <div className="text-left">
                            <div className="flex items-center justify-between">
                              <h2
                                ...
                                } font-semibold text-brand group-hover:text-blue-600 sm:leading-[19px] flex-1`}
                              >
                            ...
                            <div className="">
                              <h2 className="text-base sm:text-lg font-bold text-blue-600 group-hover:text-blue-700 transition-colors duration-300">
