                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 p-4">
                    {slide.map((product) => {
                      ...
                      return (
                        <div
                          key={product.meta.id}
                          className="bg-white border border-border2 rounded-xl shadow-lg hover:shadow-xl hover:border-blue-500 transition-all duration-300 cursor-pointer group overflow-hidden"
                          onClick={() => handleViewProduct(product.meta.id, product.overview.name)}
                        >
                          {/* Product Image */}
                          <div className="h-32 md:h-40 border-b overflow-hidden relative rounded-t-xl">
                            <img
                          ...
                          <div className="p-3 rounded-b-xl">
                            <h3 className="text-sm font-semibold text-brand group-hover:text-blue-600 transition-colors duration-300 line-clamp-2">
