    ...
    <div className="Mycontainer relative">
      ...
      >
        {slide.map((item, index) => (
          ...
          >
            <div className="w-full h-32 md:h-36 lg:h-40 flex items-center justify-center bg-white px-4 py-4 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-gray-200 transition-all duration-300">
