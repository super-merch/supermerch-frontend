    ...
    <>
                  ...
                  {route.map((link, index) => (
                    <li key={index} className="list-none cursor-pointer">
                      <Collapsible>
                        ...
                        {link.name === "Headwear" && (
                          <CollapsibleContent className="ml-4 space-y-2">
                            {megaMenuHeadwear.map((category, categoryIndex) => (
                              <div key={category.id}>
                                <button
                                ...
                                <div className="ml-6 space-y-2">
                                  {category.subTypes?.map((section, index) => (
                                    <div key={index}>
                                      {section.items.map(
                                        (subItem, subIndex) => (
                                          <div key={subIndex}>
                              ...
                              <div className="w-full p-5">
                                <div className="flex justify-start gap-10">
                                  {megaMenuClothing
                                    .find(
                                      (category) =>
                                        category.id === activeClothingItem
                                    )
      ...
      <div className="Mycontainer">
        <div className="  mt-2  lg:hidden md:hidden flex gap-2 border border-black  items-center bg-white w-full h-[40px] px-4">
          ...
          <IoSearchSharp
            onClick={handleSearch}
            className="text-xl cursoe-pointer text-black"
          />
        </div>
      </div>
