  ...
  return (
    <div className="w-full p-3 lg:p-5 md:p-5">
      <div className="flex flex-row justify-between bg-white border border-gray-300 shadow-xl ">
        {/* Sidebar */}
        <div
          className={`fixed  inset-y-0 left-0 z-[1000]  w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
            }`}
        >
