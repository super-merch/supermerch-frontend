...
const SMiniNav = () => {
  ...
  // console.log(favouriteQuantity, "favouriteQuantitys");
  ...
  // console.log(checkcatPro, "checkcatproducts");
  // console.log(categoryProducts, "thhis category products");
  ...
  // console.log(filteredProducts, "side");
  ...
  const productCategory = () => {
    ...
    // console.log(matchedProducts, "matched Products of product Category");
  ...
  // console.log(paramProducts, "porductfilter");
  ...
  const handleNameCategories = (titleName, NameId) => {
    ...
    // navigate(`/Spromotional?categoryName=${titleName}&category=${NameId}`);
    navigate(
  ...
  const handleSubCategories = (
    ...
    // navigate(`/Spromotional?categoryName=${titleName}&category=${categoryId}`);
    setSelectedParamCategoryId(categoryId);
    // console.log(subCategory, "paramcategory");
  ...
  // Function for navigating to the categories
  const conditionalCategoryNameHandler = (link) => {
    ...
    if (link.name === 'Clothing') {
      ...
      // console.log(clothingCategory.id, "clothingcategory");
                  ...
                  {route.map((link, index) => (
                    <li key={index} className='list-none'>
                      <Collapsible>
                        ...
                        {/* Show Promotional dropdown links inside collapsible when clicked */}
                        {link.name === 'Promotional' && (
                            ...
                            {megaMenu?.map((item) => (
                              ...
                              >
                                <div>
                                  ...
                                  {/* Show subcategories inside collapsible when clicking a category */}
                                  <CollapsibleContent>
                                      ...
                                      (section, index) => (
                                        <div key={index}>
                                          {section.items.map(
                                            (subItem, subIndex) => (
                                              <div key={subIndex}>
                                                {/* <h3 className="text-sm font-semibold text-blue-500">{section.label}</h3> */}
                                                <div className='space-y-2'>
                  ...
                  >
                    ...
                    >
                      <span
                        ...
                        onMouseEnter={() => {
                          link.name === 'Promotional' && sethoverMegaMenu(true);
                        }}
                        onClick={() => {
