...
const ArtWorkPolicy = () => {
  ...
  useEffect(() => {
    fetch("/api/policies/by-type/artwork")
      ...
      .catch((err) => {
        console.error("Artwork Policy Error:", err);
    ...
    return (
      <div className="min-h-screen bg-red-50 py-8 px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-red-900 mb-4">Error Loading Artwork Policy</h1>
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 py-8 px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-900">Loading Artwork Policy...</h1>
        </div>
      </div>
    );
  }
